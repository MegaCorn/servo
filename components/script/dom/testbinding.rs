...
impl TestBindingMethods<crate::DomTypeHolder> for TestBinding {
    ...
    fn PassTypedArray(&self, _: CustomAutoRooterGuard<my_js::typedarray::Int8Array>) {}
    fn PassTypedArray2(&self, _: CustomAutoRooterGuard<my_js::typedarray::ArrayBuffer>) {}
    fn PassTypedArray3(&self, _: CustomAutoRooterGuard<my_js::typedarray::ArrayBufferView>) {}
    ...
    fn PassOverloaded(&self, _: CustomAutoRooterGuard<my_js::typedarray::ArrayBuffer>) {}
    ...
    fn PassNullableTypedArray(&self, _: CustomAutoRooterGuard<Option<my_js::typedarray::Int8Array>>) {}
